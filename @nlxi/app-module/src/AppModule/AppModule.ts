...
@Module({
  imports: [
    ...
    LoggerModule.forRootAsync({
      ...
      useFactory: (configService: ConfigService) => buildLoggerOptions({ env: configService.get('env')}),
    }),
    TypeOrmModule.forRootAsync({
      imports: [ConfigModule],
      inject: [ConfigService],
      useFactory:  (configService: ConfigService) => buildOrmConfig(configService.get('db'))
    }),
